...
import 'package:food_ninja/views/product_details_page/product_details_page_provider.dart';
import 'package:food_ninja/views/profile_details_page/profile_details_page_provider.dart';
...
Route<dynamic> generateRoute(RouteSettings settings) {
  switch (settings.name) {
    ...
    case ProfileDetailsRoute:
      return MaterialPageRoute(
        builder: ((context) => ProfileDetailsPageProvider()),
      );
    default:
      return MaterialPageRoute(
        builder: ((context) => const OBScreenOne()),
