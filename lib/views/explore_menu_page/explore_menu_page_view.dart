...
class ExploreMenuPageView extends StatefulWidget {
  const ExploreMenuPageView({Key? key}) : super(key: key);

  @override
  _ExploreMenuPageViewState createState() => _ExploreMenuPageViewState();
}

class _ExploreMenuPageViewState extends State<ExploreMenuPageView> {
  @override
